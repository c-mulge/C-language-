...
void delete(struct node *head, int n1, int n2)
{
    ...
    // Now, curr1 points to the n1-th node.
    // Locate the n2-th position or the end of the list
    curr2 = curr1;
    ...
    // Now, curr2 points to the node after n2, or NULL if n2 was the last node
    back1->next = curr2->next; // Skip nodes from n1 to n2

    // Free nodes from n1 to n2
    struct node *temp;
    while (curr1 != curr2)
    {
        temp = curr1;
